...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-10 center-block">
            <br>
            <?php
            $get_pro = "SELECT * FROM products WHERE product_type='Top'";
            ...
            ?>
            <div class="row" id="men-top">
                <hr>
                <h2 class="text-center"><?php echo $pro_cat_w ?> y <?php echo $pro_type ?></h2>
                <hr>
                <div id="new-products"><?php getProWomenTop(); ?></div>
            </div>
            <div id="Men-Top">
                <br>
                <br>
                <div class="row">
                    ...
                    <hr>
                    <div id="new-products"><?php getProMenTop(); ?></div>
                </div>
            </div>
            <br>
            <div class="row">
