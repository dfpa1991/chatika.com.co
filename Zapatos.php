...
<head>
    ...
    <title>Chatika.com - Zapatos</title>
</head>
<body>
...
<div class="container-fluid" id="wrapper">
    <div class="row">
        ...
        <div class="col-xs-10 center-block">
            <br>
            <?php
            $get_pro = "SELECT * FROM products WHERE product_type='Zapatos'";
            ...
            <div class="row">
                ...
                <hr>
                <div id="pro-women-zapatos"><?php getProWomenZapatos() ?></div>
            </div>
            <div id="Men-Zapatos">
                <br>
                <br>
                <div class="row">
                    ...
                    <hr>
                    <div id="pro-men-zapatos"><?php getProMenZapatos(); ?></div>
                </div>
            </div>
            <br>
            <div class="row">
