...
<head>
    ...
    <title>Chatika.com - Resultados</title>
</head>
<body>
<!--Navbar-->
<!--Navbar Main-->
                    ...
                    if (isset($_GET['search'])) {
                        ...
                        if (mysqli_num_rows($run_pro) > 0) {
                            while ($row_pro = mysqli_fetch_array($run_pro)) {
                                ...
                                printProducts($pro_title, $pro_id, $pro_image, $pro_price);
                            ...
                            echo "
                                <div class='col-xs-10 center-block'>
                                    <br>
                                    <p class='text-center'>No hay Resultados de Busqueda para $search_query</p>
                                    <p class='text-center'>Por favor redefina su busqueda</p>
                                </div>
                            ";
                        }
                    }
